...
mod tests {
    ...
    #[case("git@github.com:jwodder/headerparser.git", Some(("jwodder", "headerparser")))]
    #[case("ssh://git@github.com:jwodder/headerparser", Some(("jwodder", "headerparser")))]
    #[case("https://api.github.com/repos/jwodder/headerparser", Some(("jwodder", "headerparser")))]
    #[case("api.github.com/repos/jwodder/headerparser", Some(("jwodder", "headerparser")))]
    #[case("https://github.com/jwodder/headerparser.git", Some(("jwodder", "headerparser")))]
    #[case("https://github.com/jwodder/headerparser.git/", Some(("jwodder", "headerparser")))]
    #[case("https://github.com/jwodder/headerparser/", Some(("jwodder", "headerparser")))]
    #[case("https://www.github.com/jwodder/headerparser", Some(("jwodder", "headerparser")))]
    #[case("github.com/jwodder/headerparser", Some(("jwodder", "headerparser")))]
